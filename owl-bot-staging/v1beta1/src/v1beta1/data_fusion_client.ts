...
export class DataFusionClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.page = {
      listAvailableVersions:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'availableVersions'),
      listInstances:
      ...
      listDnsPeerings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dnsPeerings')
    };
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1beta1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1beta1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1beta1/{resource=projects/*/locations/*/instances/*}:getIamPolicy',additional_bindings: [{get: '/v1beta1/{resource=projects/*/locations/*/instances/*/namespaces/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1beta1/{resource=projects/*/locations/*/instances/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1beta1/{resource=projects/*/locations/*/instances/*/namespaces/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1beta1/{resource=projects/*/locations/*/instances/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1beta1/{resource=projects/*/locations/*/instances/*/namespaces/*}:testIamPermissions',body: '*',}],
    ...
    const createInstanceResponse = protoFilesRoot.lookup(
      '.google.cloud.datafusion.v1beta1.Instance') as gax.protobuf.Type;
    const createInstanceMetadata = protoFilesRoot.lookup(
      '.google.cloud.datafusion.v1beta1.OperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.datafusion.v1beta1.DataFusion', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataFusionStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.datafusion.v1beta1.DataFusion') :
    ...
    const dataFusionStubMethods =
        ['listAvailableVersions', 'listInstances', 'getInstance', 'createInstance', 'deleteInstance', 'updateInstance', 'restartInstance', 'upgradeInstance', 'removeIamPolicy', 'listNamespaces', 'addDnsPeering', 'removeDnsPeering', 'listDnsPeerings'];
 ...
 */
  getInstance(
      ...
      Promise<[
        ...
        protos.google.cloud.datafusion.v1beta1.IGetInstanceRequest|undefined, {}|undefined
      ]>;
  getInstance(
      request: protos.google.cloud.datafusion.v1beta1.IGetInstanceRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.datafusion.v1beta1.IInstance,
          protos.google.cloud.datafusion.v1beta1.IGetInstanceRequest|null|undefined,
          {}|null|undefined>): void;
  getInstance(
      request: protos.google.cloud.datafusion.v1beta1.IGetInstanceRequest,
      callback: Callback<
 ...
 */
  removeIamPolicy(
      ...
      Promise<[
        ...
        protos.google.cloud.datafusion.v1beta1.IRemoveIamPolicyRequest|undefined, {}|undefined
      ]>;
  removeIamPolicy(
      request: protos.google.cloud.datafusion.v1beta1.IRemoveIamPolicyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.datafusion.v1beta1.IRemoveIamPolicyResponse,
          protos.google.cloud.datafusion.v1beta1.IRemoveIamPolicyRequest|null|undefined,
          {}|null|undefined>): void;
  removeIamPolicy(
      request: protos.google.cloud.datafusion.v1beta1.IRemoveIamPolicyRequest,
      callback: Callback<
 ...
 */
  addDnsPeering(
      ...
      Promise<[
        ...
        protos.google.cloud.datafusion.v1beta1.IAddDnsPeeringRequest|undefined, {}|undefined
      ]>;
  addDnsPeering(
      request: protos.google.cloud.datafusion.v1beta1.IAddDnsPeeringRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.datafusion.v1beta1.IAddDnsPeeringResponse,
          protos.google.cloud.datafusion.v1beta1.IAddDnsPeeringRequest|null|undefined,
          {}|null|undefined>): void;
  addDnsPeering(
      request: protos.google.cloud.datafusion.v1beta1.IAddDnsPeeringRequest,
      callback: Callback<
 ...
 */
  removeDnsPeering(
      ...
      Promise<[
        ...
        protos.google.cloud.datafusion.v1beta1.IRemoveDnsPeeringRequest|undefined, {}|undefined
      ]>;
  removeDnsPeering(
      request: protos.google.cloud.datafusion.v1beta1.IRemoveDnsPeeringRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.datafusion.v1beta1.IRemoveDnsPeeringResponse,
          protos.google.cloud.datafusion.v1beta1.IRemoveDnsPeeringRequest|null|undefined,
          {}|null|undefined>): void;
  removeDnsPeering(
      request: protos.google.cloud.datafusion.v1beta1.IRemoveDnsPeeringRequest,
      callback: Callback<
 ...
 */
  async checkCreateInstanceProgress(name: string): Promise<LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>;
  }
/**
 ...
 */
  async checkDeleteInstanceProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.datafusion.v1beta1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.datafusion.v1beta1.OperationMetadata>;
  }
/**
 ...
 */
  async checkRestartInstanceProgress(name: string): Promise<LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.restartInstance, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>;
  }
/**
 ...
 */
  async checkUpgradeInstanceProgress(name: string): Promise<LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.upgradeInstance, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.datafusion.v1beta1.Instance, protos.google.cloud.datafusion.v1beta1.OperationMetadata>;
  }
 /**
 ...
 */
  ...
  listAvailableVersions(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.datafusion.v1beta1.IListAvailableVersionsResponse|null|undefined,
          protos.google.cloud.datafusion.v1beta1.IVersion>): void;
  listAvailableVersions(
      request: protos.google.cloud.datafusion.v1beta1.IListAvailableVersionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.datafusion.v1beta1.IListAvailableVersionsRequest,
 ...
 */
  ...
  listInstances(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.datafusion.v1beta1.IListInstancesResponse|null|undefined,
          protos.google.cloud.datafusion.v1beta1.IInstance>): void;
  listInstances(
      request: protos.google.cloud.datafusion.v1beta1.IListInstancesRequest,
      callback: PaginationCallback<
          protos.google.cloud.datafusion.v1beta1.IListInstancesRequest,
 ...
 */
  ...
  listNamespaces(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.datafusion.v1beta1.IListNamespacesResponse|null|undefined,
          protos.google.cloud.datafusion.v1beta1.INamespace>): void;
  listNamespaces(
      request: protos.google.cloud.datafusion.v1beta1.IListNamespacesRequest,
      callback: PaginationCallback<
          protos.google.cloud.datafusion.v1beta1.IListNamespacesRequest,
 ...
 */
  ...
  listDnsPeerings(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.datafusion.v1beta1.IListDnsPeeringsResponse|null|undefined,
          protos.google.cloud.datafusion.v1beta1.IDnsPeering>): void;
  listDnsPeerings(
      request: protos.google.cloud.datafusion.v1beta1.IListDnsPeeringsRequest,
      callback: PaginationCallback<
          protos.google.cloud.datafusion.v1beta1.IListDnsPeeringsRequest,
 ...
 */
   ...
   * @returns {string} Resource name string.
   */
  namespacePath(project:string,location:string,instance:string,namespace:string) {
  ...
  matchInstanceFromNamespaceName(namespaceName: string) {
    return this.pathTemplates.namespacePathTemplate.match(namespaceName).instance;
  }
